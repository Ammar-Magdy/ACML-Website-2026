    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-20 transition-colors duration-300">
      ...
      <div className="relative py-32 mb-12 overflow-hidden shadow-xl">
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          {/* Blue Overlay */}
          <div className="absolute inset-0 bg-[#007bc2]/90 mix-blend-multiply"></div>
        </div>
        ...
        <div className="lg:mx-20 md:mx-10 mx-0">
          <div className="relative z-10 container mx-auto px-4 text-center">
            <h1 className="flex justify-center mb-6">
              ...
              <svg
                className="w-full max-w-3xl text-white h-24 md:h-32"
            ...
            <p className="text-lg md:text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              We believe that all children deserve a nurturing, engaging, and
              high-quality learning environment designed to support their unique
              needs throughout the critical, formative years.
            </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Access Teaching Strategies products and services in English
                  </p>
                </Link>

                <Link
                  to="/publishers/teaching/ar"
                  className="group p-8 rounded-xl border-2 border-gray-100 dark:border-gray-700 hover:border-emerald-500 dark:hover:border-emerald-500 transition-all duration-300 flex flex-col items-center hover:shadow-lg bg-gray-50 dark:bg-gray-700/30"
                >
                  <div className="w-16 h-16 bg-emerald-100 dark:bg-emerald-900/30 rounded-full flex items-center justify-center mb-4 group-hover:bg-emerald-500 group-hover:text-white transition-colors duration-300 text-emerald-600 dark:text-emerald-400">
                    <Globe size={32} />
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Access Teaching Strategies products and services in Arabic
                  </p>
                </Link>
              </div>
            </div>
