    ...
    () => ({
      ...
      ar: {
        ...
        paragraphs: [
          ...
          "نتخصص في توفير الكتب والدوريات، والمجلات الإلكترونية، وقواعد البيانات ذات النصوص الكاملة، وأنظمة أتمتة المكتبات، وأثاث المكتبات، ومواد الترميم، بالإضافة إلى بناء المكتبات الرقمية للأكواد والمواصفات الدولية ونحن المصدر الوحيد له في مصر .",
